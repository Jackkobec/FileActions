package com.jss.old_misc.students_and_lesons;
...
public class Student {
    ...
    public  String studentToString(Student student) {
        return String.format("name: %s\nadress: %s\nlessonsList: %s\n",
                student.name, student.adress, Lesson.listAllLesson(student.lessonsList));
    }

    public String studentToString() {
        return String.format("Name: %s\nAdress: %s\n\nLessonsList: %s\n",
                name, adress, Lesson.listAllLesson(lessonsList));
    }
